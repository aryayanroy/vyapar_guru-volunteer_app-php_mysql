<?php
    ...
    include "config.php";
    $sql = $conn->prepare("SELECT name, email, phone FROM users WHERE id = ?");
                ...
                <div class="collapse navbar-collapse flex-grow-0">
                    <ul class="navbar-nav d-none d-md-flex">
                        ...
                        <li class="nav-item dropdown">
                            <a href="profile" class="nav-link fw-bold dropdown-toggle" data-bs-toggle="dropdown"><i class="fa-regular fa-circle-user fa-lg me-2"></i><span>Hello, <?php echo $user[0] ?></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="profile" class="dropdown-item">Profile</a></li>
                                <li><a href="settings" class="dropdown-item">Settings</a></li>
                                <li><a href="profile" class="dropdown-item">Businesses</a></li>
...
<aside id="aside-right" class="offcanvas offcanvas-end">
    ...
    <div class="offcanvas-body">
        <div class="list-group list-group-flush">
            ...
            <a href="businesses" class="list-group-item list-group-item-action">Businesses</a>
