<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        require "config.php";
        $sql = $conn->prepare("SELECT id, password FROM users WHERE email = :id OR phone = :id");
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1">
        <article class="container-xxl py-3">
            <form action="<?php ?>" method="post" class="mx-auto my-5" style="max-width: 400px">
                ...
                <div class="py-5">
                    ...
                    <div class="form-floating">
                        <input type="text" id="id" name="id" class="form-control" placeholder="Email or Phone" spellcheck="false" required>
                    ...
                    <div class="mb-3">By continuing, you agree to our <a href="#" class="text-decoration-none">Terms</a> and <a href="#" class="text-decoration-none">Privacy</a>.</div>
