...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="container-xl">
                ...
                <div class="collapse navbar-collapse flex-grow-0">
                    <ul class="navbar-nav d-none d-md-flex">
                        <li class="nav-item"><a href="home" class="nav-link active"><i class="fa-solid fa-house me-2"></i><b>Home</b></a></li>
    ...
    <main class="flex-grow-1 bg-body-secondary">
        <article class="container-xxl py-3">
            ...
            ?>
            <ul class="list-group list-group-flush mt-5 mx-auto" style="max-width: 600px">
                <li class="list-group-item">
                    <h6>Sabrina Carpenter</h6>
                </li>
                <li class="list-group-item">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat accusantium excepturi beatae, cum magnam libero labore odio nulla accusamus rerum ipsum placeat laboriosam? Consectetur minima ipsum magni perspiciatis molestias magnam.
                </li>
            </ul>
        </article>
    </main>
