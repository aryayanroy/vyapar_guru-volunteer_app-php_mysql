...
<head>
    ...
    <title>Vyapar Guru | Connecting Small Businesses to Volunteers</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1" style="background: url(assets/public/images/1694269696.webp) fixed center/cover no-repeat">
        <article class="container-xxl py-5">
            <h1 class="text-white text-center mt-5">Empowering Local Businesses in the Digital Era</h1>
            <div class="mx-auto mb-5" style="max-width: 600px">
                <form action="" method="get" class="row g-3">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-floating">
                            <select id="type" name="type" class="form-select">
                                ...
                                <option value="">Small Businesses</option>
                            </select>
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-floating">
                            <input type="text" id="search" name="q" class="form-control" placeholder="Search" autocomplete="off" spellcheck="false" required>
                            <label for="search">Search for Volunteers, Businesses</label>
                        </div>
                    </div>
                    <div class="col-12">
